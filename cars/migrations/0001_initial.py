    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_1', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d')),
                ('photo_2', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d')),
                ('photo_3', models.ImageField(blank=True, upload_to='photos/cars/%Y/%m/%d')),
